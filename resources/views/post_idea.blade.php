        ...
        <div class="p-postIdea__content">
            ...
            <form method="POST" action="{{ route('post_idea', auth()->user()->id) }}" class="p-postIdea__form">
                ...
                <div class="p-postIdea__part">
                    ...
                    <input type="text" id="js-count-name" class="p-postIdea__input @error('idea_name') is-error @enderror" name="idea_name" value="{{ old('idea_name') }}" placeholder="20文字以内で入力してください" onkeyup="ShowLength(value, 'count-idea');">
                    <div class="p-profile__countarea">
                        <span id="count-idea" class="c-countarea--name js-show-count-name">0</span>/20
                    </div>
                </div>
                ...
                <div class="p-postIdea__part">
                    ...
                    <textarea name="summary" id="js-count-comment" class="p-postIdea__textarea" placeholder="100文字以内で入力してください">{{ old('summary') }}</textarea>
