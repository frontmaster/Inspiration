    ...
    <ul>
        ...
        <div class="c-sidebar__menublock">
            ...
            <li class="c-sidebar__menu--short">
                <a href="{{ route('post_idea', auth()->user()->id) }}" class="c-sidebar__menu--link">アイディアを投稿する</a>
            </li>
        </div>
        ...
        <div class="c-sidebar__menublock">
            ...
            <li class="c-sidebar__menu--mid">
                <a href="{{ route('post_idea_list', auth()->user()->id) }}" class="c-sidebar__menu--link">投稿したアイディア一覧</a>
            </li>
            <li class="c-sidebar__menu--mid">
